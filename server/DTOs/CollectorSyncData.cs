...
namespace OneSecurity.Server.DTOs
{
    public class CollectorSyncData
    {
        ...
        public Dictionary<string, string> AgentIdToHostnameMap { get; set; } = new(); // AgentId -> Hostname
        public Dictionary<string, long> AssetCollectorMap { get; set; } = new(); // Hostname -> CollectorId
